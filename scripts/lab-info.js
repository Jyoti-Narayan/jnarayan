...
function renderLabBanner(labInfo) {
    ...
    const labName = labInfo?.lab_name || 'Smart Healthcare & Robotics Interfacing Laboratory (SHRI Laboratory)';
    const labFullName = labInfo?.lab_full_name || 'Smart Healthcare & Robotics Interfacing Laboratory (SHRI Laboratory)';
